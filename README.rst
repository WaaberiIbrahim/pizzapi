...
This is made for Canada.
If you're from the US, use the original one.
...
.. code-block:: python
    ...
    customer = Customer('John', 'Doe', 'johndoe@rhyta.com', '6137371111', '24 Sussex Dr, Ottawa, ON, K1M 1M8')
